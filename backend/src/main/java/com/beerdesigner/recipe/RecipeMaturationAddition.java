...
public class RecipeMaturationAddition {
 ...
 private String type; @Column(name="hop_id") private String hopId; @Column(name="adjunct_id") private String adjunctId; private String name; private BigDecimal amount; private String unit;
