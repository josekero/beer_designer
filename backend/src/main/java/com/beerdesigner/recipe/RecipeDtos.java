...
public final class RecipeDtos {
  ...
  public record RecipeDetailDto(
      ...
      List<RecipeFermentationStepDto> fermentationSteps,
  ...
  public record RecipeHopDto(String type,String hopId,String adjunctId,BigDecimal amountG,BigDecimal alphaAcids,Integer timeMin,BigDecimal temperatureC,String use,String notes) {}
  ...
  public record RecipeWaterAdditionDto(String saltId,String name,BigDecimal amountG) {}
  ...
  public record RecipeMaturationAdditionDto(String type,String hopId,String adjunctId,String name,String batch,BigDecimal amount,String unit,Integer addDay,Integer contactDays,BigDecimal temperatureC,String notes) {}
  public record RecipeFermentationStepDto(String stage,Integer startDay,Integer durationDays,BigDecimal temperatureC,String notes) {}
