...
export class ProfileManager implements OnInit {
  private fb=inject(FormBuilder); private api=inject(ApiRepositoryService); private notifications=inject(NotificationService); private cdr=inject(ChangeDetectorRef);
