...
const ENGLISH_UI: Record<string, string> = {
  'El punto de encuentro': 'The meeting point',
  'Recetas contrastadas, ingredientes únicos y cerveceros compartiendo conocimiento.':
    'Proven recipes, unique ingredients and brewers sharing knowledge.',
  plantillas: 'templates',
  recetas: 'recipes',
  ingredientes: 'ingredients',
  cerveceros: 'brewers',
  'activos ahora': 'active now',
  'Sirviendo la ronda comunitaria…': 'Serving the community round…',
  'SELECCIÓN OFICIAL': 'OFFICIAL SELECTION',
  'Plantillas de Beer Designer': 'Beer Designer templates',
  'Recetas del administrador preparadas como punto de partida': 'Administrator recipes prepared as a starting point',
  'Baseline oficial': 'Official baseline',
  'Una receta preparada por Beer Designer para comenzar.': 'A Beer Designer recipe ready to get you started.',
  'Estilo libre': 'Free style',
  'Copiar plantilla': 'Copy template',
  Copiar: 'Copy',
  copias: 'copies',
  'Me gusta': 'Like',
  'Cerveceros que la han copiado': 'Brewers who copied it',
  'Ver receta': 'View recipe',
  'Buscar por receta, estilo o autor…': 'Search by recipe, style or author…',
  Buscar: 'Search',
  'Ordenar plantillas': 'Sort templates',
  'Ordenar recetas': 'Sort recipes',
  'Más recientes': 'Most recent',
  'Más gustadas': 'Most liked',
  'Más copiadas': 'Most copied',
  'Páginas de plantillas': 'Template pages',
  'Páginas de recetas': 'Recipe pages',
  Página: 'Page',
  'Cargando recetas…': 'Loading recipes…',
  'Vista previa completa de la receta': 'Full recipe preview',
  'RECETA COMPARTIDA': 'SHARED RECIPE',
  'Cargando receta…': 'Loading recipe…',
  'Cerrar vista previa': 'Close preview',
  'Abriendo todos los detalles…': 'Opening all recipe details…',
  Volumen: 'Volume',
  Hervido: 'Boil',
  'Maltas y fermentables': 'Malts and fermentables',
  'Sin maltas definidas': 'No malts defined',
  'Sin adiciones calientes': 'No hot-side additions',
  'Sin levaduras definidas': 'No yeasts defined',
  'Sin pasos definidos': 'No steps defined',
  'Fermentación y maduración': 'Fermentation and conditioning',
  Día: 'Day',
  'Copiar a mi recetario': 'Copy to my recipe book',
  'Las plantillas oficiales están fermentando': 'The official templates are fermenting',
  'Administración todavía no ha publicado ninguna baseline.': 'Administration has not published a baseline yet.',
  'ÚLTIMAS NOVEDADES': 'LATEST UPDATES',
  'Recetas de la comunidad': 'Community recipes',
  'Publicadas por sus propios autores': 'Published by their authors',
  'Sin notas públicas.': 'No public notes.',
  'Mi recetario': 'My recipe book',
  'Aún no hay recetas públicas': 'There are no public recipes yet',
  'Sé el primero en compartir una con la comunidad.': 'Be the first to share one with the community.',
  'DESPENSA COMUNITARIA': 'COMMUNITY PANTRY',
  'Ingredientes compartidos': 'Shared ingredients',
  'Descubre referencias creadas y probadas por otros usuarios': 'Discover ingredients created and tested by other users',
  'Filtrar ingredientes': 'Filter ingredients',
  Tuyo: 'Yours',
  'Sin descripción pública.': 'No public description.',
  'En tu catálogo': 'In your catalog',
  'No hay ingredientes de este tipo todavía': 'There are no ingredients of this type yet',
  'Los ingredientes personales que se compartan aparecerán aquí.': 'Shared personal ingredients will appear here.',
  'TU APORTE': 'YOUR CONTRIBUTION',
  'Mis publicaciones': 'My publications',
  'Abrir biblioteca': 'Open library',
  'Ingredientes personales': 'Personal ingredients',
  'Visible en Community': 'Visible in Community',
  'Solo para ti': 'Only for you',
  'Dejar privada': 'Make private',
  'Dejar privado': 'Make private',
  Compartir: 'Share',
  'Crea un ingrediente personal para poder compartirlo.': 'Create a personal ingredient to share it.',
  'LA COMUNIDAD': 'THE COMMUNITY',
  'Nuevos cerveceros': 'New brewers',
  Desde: 'Since',
  Lúpulo: 'Hop',
  Malta: 'Malt',
  Levadura: 'Yeast',
